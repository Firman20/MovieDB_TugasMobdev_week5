...
public class MovieDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lbl_title = findViewById(R.id.lbl_title_details);
        lbl_textMovieId = findViewById(R.id.lbl_movie_details);
        lbl_desc = findViewById(R.id.lbl_desc_details);
        lbl_textOriginalTitle = findViewById(R.id.lbl_original_title_details);
        lbl_textReleaseDate = findViewById(R.id.lbl_releasedate_details);
        ...
        lbl_genre = findViewById(R.id.genre_details);
